# Available .MENU One-Word Domains (9,609)
...
**Public extract:** 9,612 rows · **Live catalog:** 9,609 domains
...
| ----------------------- | ------------------------------------------------ |
| 9,612-row public sample | 9,609 live domains                               |
...
> Unique Domains. *Available .MENU One-Word Domains*. Version 2026-04-12. Public GitHub extract for the exact Unique Domains search represented by this repository.
