# Available .MENU One-Word Domains (5,622,473)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C609%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-5%2C622%2C473%20domains-6f42c1">
...
> **Important:** this repository is a **public 9,609-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,473 domains** on the canonical page below.

**Public extract:** 9,609 rows · **Live catalog:** 5,622,473 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/menu?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_menu_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/menu?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_menu_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./menu.csv">CSV</a> / <a href="./menu.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_menu_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_menu_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .MENU search](https://unique.domains/domains/tld/menu?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_menu_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .MENU search](https://unique.domains/domains/tld/menu?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_menu_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./menu.csv) or [Download JSON](./menu.json)
...
- `menu.csv` — public CSV extract (9,609 rows)
- `menu.json` — public JSON extract (9,609 rows)
...
| ----------------------- | ------------------------------------------------ |
| 9,609-row public sample | 5,622,473 live domains                           |
...
| bot.menu        | resell    | —         | —             | 98             | 61     | 3      | Dynadot Inc         |
| agile.menu      | premium   | $38.98    | —             | 92             | 42     | 5      | namecheap           |
...
| choice.menu     | premium   | $81.25    | $81.25        | 74             | 32     | 6      | name.com            |
| law.menu        | available | $38.98    | —             | 82             | 48     | 3      | namecheap           |
| people.menu     | resell    | —         | —             | 102            | 44     | 6      | GoDaddy.com, LLC    |
| abstract.menu   | premium   | $44.99    | $46.99        | 108            | 31     | 8      | name.com            |
| genius.menu     | available | $38.98    | —             | 98             | 47     | 6      | namecheap           |
...
| mass.menu       | premium   | $81.25    | $81.25        | 78             | 29     | 4      | name.com            |
| strategy.menu   | available | $38.98    | —             | 74             | 43     | 8      | namecheap           |
| universe.menu   | resell    | —         | —             | 74             | 40     | 8      | GoDaddy.com, LLC    |
...
> Unique Domains. *Available .MENU One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
